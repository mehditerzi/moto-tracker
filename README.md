...
│                  │         │              └── React PWA (static)     │
└──────────────────┘         │                                         │
                             │  ollama   (vision model, e.g. gemma4)   │
                             │  sqlite   (./data/app.db)               │
                             └─────────────────────────────────────────┘
```
...
5. pull the configured Ollama vision model (`gemma4` by default)
...
| `OLLAMA_VISION_MODEL` | no | default `gemma4`; pin a specific tag (e.g. `gemma4:e2b`) for determinism |

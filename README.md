...
│                  │         │              └── React PWA (static)     │
└──────────────────┘         │                                         │
                             │  ollama   (vision model, e.g. gemma4:26b)   │
                             │  sqlite   (./data/app.db)               │
                             └─────────────────────────────────────────┘
```
...
| `OLLAMA_VISION_MODEL` | no | default `gemma4:26b`; pin a different tag (e.g. `gemma4:e2b` for a smaller model) by setting this in `.env` |
